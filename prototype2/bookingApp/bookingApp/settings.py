...
# redirects un logged in users to my landing page
...
EMAIL_PORT = 587  # Usually port 587 for TLS
EMAIL_USE_TLS = True
EMAIL_HOST_USER = ''  # Your Brevo email/login
EMAIL_HOST_PASSWORD = ''  # Your Brevo SMTP password
DEFAULT_FROM_EMAIL = ''  # Your Brevo email (optional, but recommended)
