    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('userID', models.CharField(max_length=50, unique=True, verbose_name='user ID')),
        ...
        migrations.CreateModel(
            name='BusinessUser',
            fields=[
                ('customuser_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='business.customuser')),
